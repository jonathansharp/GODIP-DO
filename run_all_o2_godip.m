...
%% Import data
process_WOD_profile_data(start_year,end_year,vrs);
% plot data histogram by year
plot_data_hist(start_year,end_year,vrs);
plot_data_map(start_year,end_year,vrs);
...
assign_data_to_clusters(param_props,snap_date,...
    float_file_ext,clust_vars,num_clusters,start_year,end_year,vrs);
% plot clustered data points
plot_data_by_cluster(param_props,file_date,float_file_ext,...
    num_clusters,numWorkers_predict,start_year,end_year,vrs);
...
train_gobai('FFNN',param_props,file_date,float_file_ext,...
    num_clusters,variables,thresh,numWorkers_train,snap_date,...
    start_year,end_year,vrs,'reduce_data',data_per,'train_ratio',...
    train_ratio,'val_ratio',val_ratio,'test_ratio',test_ratio);
...
predict_gobai('FFNN',param_props,fpaths,base_grid,file_date,float_file_ext,...
    ...
    end_year,snap_date,vrs,'train_ratio',train_ratio,'val_ratio',val_ratio,...
