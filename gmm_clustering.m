function gmm_clustering(param_props,fpaths,start_year,end_year,snap_date,...
...
idx = false(length(all_data.(clust_vars{1})),1);
...
% folder_name = [fpaths.param_path 'GMM_' num2str(num_clusters)];
